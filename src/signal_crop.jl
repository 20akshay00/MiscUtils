...
data = load("../sample_data/signal_crop.jld")["img"];
...
md"""
### How?
In this technique, we simply take a range of indices (forming a hypercube) around a given peak within a specified window, and compute the standard deviation of the intensity values inside it. Plotting this for various window sizes consistently gives us the following qualitative curve:
"""
...
md"""
The boxed standard deviation measure always increases to reach a maximum value and continues to monotonically decrease to 0. The maximum value of this measure gives us a qualitative correspondence to the `extent` of the signal. We simply extract this value and use an appropriate multiplier to crop the data as required.
"""

# ╔═╡ 7fc66f67-4dcd-4d06-baa9-f10405a32d00
md"""
### Caveats
- The technique is highly sensitive to the `anchor` i.e. the peak of the signal.
- The signal must have the following features to assure optimal performance of this technique:
- - minimal overlap with other signals
- - roughly symmetric spread (i.e., gaussian-like, without long tails)
"""

# ╔═╡ 96415a7b-234d-4a05-8a4f-19ab35c017ba
md"""
### Acknowledgement
The key observation that lends credibility to this technique was made by [Dhruva](https://github.com/DhruvaSambrani/).
"""
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "0cb7f6c1c57725f0b9e29dc16d6632716ce8314b"
